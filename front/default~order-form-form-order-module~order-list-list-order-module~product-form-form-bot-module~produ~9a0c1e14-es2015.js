...
function BreadcrumbsComponent_ng_container_4_a_4_Template(rf, ctx) {
    ...
    if (rf & 2) {
        const crumb_r1 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit;
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("routerLink", crumb_r1.url);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate"](crumb_r1.text);
    }
}
function BreadcrumbsComponent_ng_container_4_Template(rf, ctx) {
    if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](3, BreadcrumbsComponent_ng_container_4_a_3_Template, 2, 3, "a", 5);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](4, BreadcrumbsComponent_ng_container_4_a_4_Template, 2, 2, "a", 5);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    ...
    if (rf & 2) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngIf", !crumb_r1.url);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngIf", crumb_r1.url);
    }
}
...
let BreadcrumbsComponent = /*@__PURE__*/ (() => {
    ...
    BreadcrumbsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: BreadcrumbsComponent, selectors: [["vex-breadcrumbs"]], inputs: { crumbs: "crumbs" }, decls: 5, vars: 5, consts: [[1, "flex", "items-center"], [3, "routerLink"], ["inline", "true", "size", "20px", 3, "icon"], [4, "ngFor", "ngForOf", "ngForTrackBy"], [1, "w-1", "h-1", "bg-gray", "rounded-full", "ltr:mr-2", "rtl:ml-2"], [3, "routerLink", 4, "ngIf"]], template: function BreadcrumbsComponent_Template(rf, ctx) {
            if (rf & 1) {
                ...
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](4, BreadcrumbsComponent_ng_container_4_Template, 5, 2, "ng-container", 3);
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
            }
            if (rf & 2) {
...
let BreadcrumbsModule = /*@__PURE__*/ (() => {
...
(function () {
    (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](BreadcrumbsModule, { declarations: [_breadcrumbs_component__WEBPACK_IMPORTED_MODULE_3__["BreadcrumbsComponent"], _breadcrumb_breadcrumb_component__WEBPACK_IMPORTED_MODULE_7__["BreadcrumbComponent"]], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_0__["CommonModule"],
            _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"],
            _angular_material_icon__WEBPACK_IMPORTED_MODULE_4__["MatIconModule"],
            _angular_flex_layout__WEBPACK_IMPORTED_MODULE_5__["FlexLayoutModule"],
...
const _c1 = ["*"];
let SecondaryToolbarComponent = /*@__PURE__*/ (() => {
...
let SecondaryToolbarModule = /*@__PURE__*/ (() => {
...
(function () {
    (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](SecondaryToolbarModule, { declarations: [_secondary_toolbar_component__WEBPACK_IMPORTED_MODULE_2__["SecondaryToolbarComponent"]], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"],
            _angular_flex_layout__WEBPACK_IMPORTED_MODULE_3__["FlexLayoutModule"],
            _visurel_iconify_angular__WEBPACK_IMPORTED_MODULE_4__["IconModule"],
            _angular_router__WEBPACK_IMPORTED_MODULE_5__["RouterModule"],
            _angular_material_button__WEBPACK_IMPORTED_MODULE_6__["MatButtonModule"],
...
let ProductService = /*@__PURE__*/ (() => {
    class ProductService {
        constructor(httpService, utilService, httpClient) {
        ...
        listProducts() {
            let httpUrl = `${this.http}/product`;
            return this.httpClient.get(httpUrl);
        }
        listProductsByWhareHouse(idWhareHouse) {
            let httpUrl = `${this.http}/product/?wharehouse=${idWhareHouse}`;
            return this.httpClient.get(httpUrl);
        }
        listOrderByWhareHouse(idWhareHouse) {
            let httpUrl = `${this.http}/order/?wharehouse=${idWhareHouse}`;
            return this.httpClient.get(httpUrl);
        }
        addBot(body) {
            let httpUrl = `${this.http}/product/`;
        ...
        addOrder(body) {
            let httpUrl = `${this.http}/order/`;
            return this.httpClient.post(httpUrl, body);
        }
        updateBot(id, body) {
            let httpUrl = `${this.http}/product/${id}/`;
            return this.httpClient.put(httpUrl, body);
        }
    }
    ProductService.ɵfac = function ProductService_Factory(t) { return new (t || ProductService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_utils_basehttp_basehttp_service__WEBPACK_IMPORTED_MODULE_1__["BasehttpService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_utils_util_util_service__WEBPACK_IMPORTED_MODULE_2__["UtilService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"])); };
...
//# sourceMappingURL=default~order-form-form-order-module~order-list-list-order-module~product-form-form-bot-module~produ~9a0c1e14-es2015.js.map